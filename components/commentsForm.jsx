...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      ...
      {error && (
        <p className='text-xs text-red-500'>Todos os campos são obrigatórios</p>
      )}
      <div className='mt-8'>
        <button
          type='button'
          onClick={handlePostSubmission}
          className='transition duration-500 ease hover:bg-green-900 inline-block bg-orange-500 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer'
        >
          Enviar Comentario
        </button>
        {showSuccessMessage && (
